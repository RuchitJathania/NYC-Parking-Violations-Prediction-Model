...
# Calculate accuracy
print("Accuracy:", accuracy_score(actual_fine_amounts, predicted_fine_amounts))
...
# )
#
# # Train Neural Network with early stopping and lr scheduler
...
#
#
# nn_model.save(f'saved_model/{model2_name}')
